...
@section('subtitle', 'Create Call')
@section('content_header_title', 'Calls')
@section('content_header_subtitle', 'Create New Call')
                ...
                <form action="{{ route('calls.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('call_id') is-invalid @enderror" id="call_id" name="call_id" value="{{ old('call_id') }}">
                            @error('call_id')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('reported_problem') is-invalid @enderror" id="reported_problem" name="reported_problem" rows="3">{{ old('reported_problem') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('action_taken') is-invalid @enderror" id="action_taken" name="action_taken" rows="3">{{ old('action_taken') }}</textarea>
                            @error('action_taken')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('next_follow_up_date') is-invalid @enderror" id="next_follow_up_date" name="next_follow_up_date" value="{{ old('next_follow_up_date') }}">
